...
public class AdapterPesquisa extends RecyclerView.Adapter<AdapterPesquisa.MyViewHolder> {
    ...
    @NonNull
    @Override
    public AdapterPesquisa.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterPesquisa.MyViewHolder holder, int position) {
